...
class AmateurMatchSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = AmateurMatch
        fields = ['id', 'name', 'start', 'address', 'city', 'lat', 'lon', 'owner', "canceled", 'enter_price', 'sport', 'auto_accept_participants', 'photo', 'photo_base64', 'max_participants', 'participants', 'requests' ]
